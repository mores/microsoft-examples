...
namespace XrmEbc
{
	...
	public partial class KnowledgeArticleIncident : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object KnowledgeUsage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("knowledgeusage");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Nullable<XrmEbc.KnowledgeArticleIncidentState> statecode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.KnowledgeArticleIncidentState)(System.Enum.ToObject(typeof(XrmEbc.KnowledgeArticleIncidentState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.PrincipalObjectAttributeAccess> knowledgearticleincident_principalobjectattributeaccess
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.PrincipalObjectAttributeAccess>("knowledgearticleincident_principalobjectattributeaccess", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticleincident_principalobjectattributeaccess");
				this.SetRelatedEntities<XrmEbc.PrincipalObjectAttributeAccess>("knowledgearticleincident_principalobjectattributeaccess", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SyncError> KnowledgeArticleIncident_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SyncError>("KnowledgeArticleIncident_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("KnowledgeArticleIncident_SyncErrors");
				this.SetRelatedEntities<XrmEbc.SyncError>("KnowledgeArticleIncident_SyncErrors", null, value);
		...
		public XrmEbc.KnowledgeArticle incident_knowledgearticles
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.KnowledgeArticle>("incident_knowledgearticles", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("incident_knowledgearticles");
				this.SetRelatedEntity<XrmEbc.KnowledgeArticle>("incident_knowledgearticles", null, value);
		...
		public XrmEbc.Incident knowledgearticle_incidents
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Incident>("knowledgearticle_incidents", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_incidents");
				this.SetRelatedEntity<XrmEbc.Incident>("knowledgearticle_incidents", null, value);
		...
		public XrmEbc.SystemUser lk_knowledgearticleincident_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgearticleincident_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_knowledgearticleincident_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgearticleincident_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleincident_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgearticleincident_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_knowledgearticleincident_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgearticleincident_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_knowledgearticleincident_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgearticleincident_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleincident_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgearticleincident_modifiedonbehalfby", null, value);
		...
		public XrmEbc.TransactionCurrency transactioncurrency_knowledgearticleincident
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("transactioncurrency_knowledgearticleincident", null);
			}
		}
