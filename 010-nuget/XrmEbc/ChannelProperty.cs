...
namespace XrmEbc
{
	...
	public partial class ChannelProperty : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.ChannelPropertyState> statecode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.ChannelPropertyState)(System.Enum.ToObject(typeof(XrmEbc.ChannelPropertyState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public XrmEbc.Organization channelproperty_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("channelproperty_organization", null);
			}
		}
		...
		public XrmEbc.ChannelPropertyGroup ChannelPropertyGroup_ChannelProperty
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.ChannelPropertyGroup>("ChannelPropertyGroup_ChannelProperty", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ChannelPropertyGroup_ChannelProperty");
				this.SetRelatedEntity<XrmEbc.ChannelPropertyGroup>("ChannelPropertyGroup_ChannelProperty", null, value);
		...
		public XrmEbc.SystemUser lk_ChannelProperty_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_ChannelProperty_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_ChannelProperty_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_ChannelProperty_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ChannelProperty_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_ChannelProperty_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_ChannelProperty_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_ChannelProperty_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_ChannelProperty_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_ChannelProperty_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ChannelProperty_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_ChannelProperty_modifiedonbehalfby", null, value);
