...
namespace XrmEbc
{
	...
	public partial class RecommendationModelVersionHistory : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Shows how long, it took to finish the workflow step.
		/// </summary>
		...
		public object WorkflowStep
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("workflowstep");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public object WorkflowStepStatus
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("workflowstepstatus");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public XrmEbc.Organization organization_recommendationmodelversionhistory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_recommendationmodelversionhistory", null);
			}
		}
		...
		public XrmEbc.RecommendationModelVersion recommendationmodelversion_recommendationmodelversionhistory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.RecommendationModelVersion>("recommendationmodelversion_recommendationmodelversionhistory", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("recommendationmodelversion_recommendationmodelversionhistory");
				this.SetRelatedEntity<XrmEbc.RecommendationModelVersion>("recommendationmodelversion_recommendationmodelversionhistory", null, value);
