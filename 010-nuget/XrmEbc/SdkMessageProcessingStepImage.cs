...
namespace XrmEbc
{
	...
	public partial class SdkMessageProcessingStepImage : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object ImageType
		{
			...
			get
			{
				return this.GetAttributeValue<object>("imagetype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_sdkmessageprocessingstepimage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_sdkmessageprocessingstepimage", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_sdkmessageprocessingstepimage");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_sdkmessageprocessingstepimage", null, value);
		...
		public XrmEbc.SystemUser createdby_sdkmessageprocessingstepimage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("createdby_sdkmessageprocessingstepimage", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_sdkmessageprocessingstepimage_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageprocessingstepimage_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessageprocessingstepimage_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageprocessingstepimage_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_sdkmessageprocessingstepimage_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageprocessingstepimage_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessageprocessingstepimage_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageprocessingstepimage_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser modifiedby_sdkmessageprocessingstepimage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("modifiedby_sdkmessageprocessingstepimage", null);
			}
		}
		...
		public XrmEbc.Organization organization_sdkmessageprocessingstepimage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_sdkmessageprocessingstepimage", null);
			}
		}
		...
		public XrmEbc.SdkMessageProcessingStep sdkmessageprocessingstepid_sdkmessageprocessingstepimage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SdkMessageProcessingStep>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdkmessageprocessingstepid_sdkmessageprocessingstepimage");
				this.SetRelatedEntity<XrmEbc.SdkMessageProcessingStep>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null, value);
