...
namespace XrmEbc
{
	...
	public partial class TopicModelConfiguration : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object TimeFilter
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("timefilter");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TextAnalyticsEntityMapping> topicmodelconfiguration_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TextAnalyticsEntityMapping>("topicmodelconfiguration_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_textanalyticsentitymapping");
				this.SetRelatedEntities<XrmEbc.TextAnalyticsEntityMapping>("topicmodelconfiguration_textanalyticsentitymapping", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TopicModel> topicmodelconfiguration_topicmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TopicModel>("topicmodelconfiguration_topicmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_topicmodel");
				this.SetRelatedEntities<XrmEbc.TopicModel>("topicmodelconfiguration_topicmodel", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TopicModelExecutionHistory> topicmodelconfiguration_topicmodelexecutionhistory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TopicModelExecutionHistory>("topicmodelconfiguration_topicmodelexecutionhistory", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_topicmodelexecutionhistory");
				this.SetRelatedEntities<XrmEbc.TopicModelExecutionHistory>("topicmodelconfiguration_topicmodelexecutionhistory", null, value);
		...
		public XrmEbc.Organization organization_topicmodelconfiguration
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_topicmodelconfiguration", null);
			}
		}
		...
		public XrmEbc.TopicModel topicmodel_topicmodelconfiguration
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TopicModel>("topicmodel_topicmodelconfiguration", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodel_topicmodelconfiguration");
				this.SetRelatedEntity<XrmEbc.TopicModel>("topicmodel_topicmodelconfiguration", null, value);
