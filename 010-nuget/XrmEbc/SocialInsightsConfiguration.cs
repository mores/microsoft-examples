...
namespace XrmEbc
{
	...
	public partial class SocialInsightsConfiguration : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object SocialDataItemType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("socialdataitemtype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public XrmEbc.SystemUser lk_socialinsightsconfiguration_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_socialinsightsconfiguration_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_socialinsightsconfiguration_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_socialinsightsconfiguration_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_socialinsightsconfiguration_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_socialinsightsconfiguration_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_socialinsightsconfiguration_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_socialinsightsconfiguration_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_socialinsightsconfiguration_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_socialinsightsconfiguration_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_socialinsightsconfiguration_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_socialinsightsconfiguration_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_socialinsightsconfiguration
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_socialinsightsconfiguration", null);
			}
		}
		...
		public XrmEbc.SystemForm socialinsightsconfiguration_systemform
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemForm>("socialinsightsconfiguration_systemform", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("socialinsightsconfiguration_systemform");
				this.SetRelatedEntity<XrmEbc.SystemForm>("socialinsightsconfiguration_systemform", null, value);
		...
		public XrmEbc.UserForm socialinsightsconfiguration_userform
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.UserForm>("socialinsightsconfiguration_userform", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("socialinsightsconfiguration_userform");
				this.SetRelatedEntity<XrmEbc.UserForm>("socialinsightsconfiguration_userform", null, value);
