...
namespace XrmEbc
{
	...
	public partial class SolutionComponent : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object ComponentType
		{
			...
			get
			{
				return this.GetAttributeValue<object>("componenttype");
			}
		}
		...
		public object RootComponentBehavior
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("rootcomponentbehavior");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SolutionComponent> Referencedsolutioncomponent_parent_solutioncomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SolutionComponent>("solutioncomponent_parent_solutioncomponent", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencedsolutioncomponent_parent_solutioncomponent");
				this.SetRelatedEntities<XrmEbc.SolutionComponent>("solutioncomponent_parent_solutioncomponent", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_solutioncomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_solutioncomponent", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_solutioncomponent");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_solutioncomponent", null, value);
		...
		public XrmEbc.SystemUser lk_solutioncomponentbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_solutioncomponentbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_solutioncomponentbase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_solutioncomponentbase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_solutioncomponentbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_solutioncomponentbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_solutioncomponentbase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_solutioncomponentbase_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Solution solution_solutioncomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Solution>("solution_solutioncomponent", null);
			}
		}
		...
		public XrmEbc.SolutionComponent Referencingsolutioncomponent_parent_solutioncomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SolutionComponent>("solutioncomponent_parent_solutioncomponent", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
