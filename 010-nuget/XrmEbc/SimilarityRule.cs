...
namespace XrmEbc
{
	...
	public partial class SimilarityRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.SimilarityRuleState> statecode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.SimilarityRuleState)(System.Enum.ToObject(typeof(XrmEbc.SimilarityRuleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.AsyncOperation> similarityrule_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.AsyncOperation>("similarityrule_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("similarityrule_AsyncOperations");
				this.SetRelatedEntities<XrmEbc.AsyncOperation>("similarityrule_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TextAnalyticsEntityMapping> similarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TextAnalyticsEntityMapping>("similarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("similarityrule_textanalyticsentitymapping");
				this.SetRelatedEntities<XrmEbc.TextAnalyticsEntityMapping>("similarityrule_textanalyticsentitymapping", null, value);
		...
		public XrmEbc.SystemUser lk_similarityrule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_similarityrule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_similarityrule_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_similarityrule_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_similarityrule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_similarityrule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_similarityrule_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_similarityrule_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_similarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_similarityrule", null);
			}
		}
		...
		public XrmEbc.TransactionCurrency TransactionCurrency_SimilarityRule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_SimilarityRule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_SimilarityRule");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_SimilarityRule", null, value);
