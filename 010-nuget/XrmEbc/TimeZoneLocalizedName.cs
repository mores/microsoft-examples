...
namespace XrmEbc
{
	...
	public partial class TimeZoneLocalizedName : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_timezonelocalizedname
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_timezonelocalizedname", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_timezonelocalizedname");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_timezonelocalizedname", null, value);
		...
		public XrmEbc.SystemUser lk_timezonelocalizedname_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonelocalizedname_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_timezonelocalizedname_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonelocalizedname_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonelocalizedname_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_timezonelocalizedname_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_timezonelocalizedname_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonelocalizedname_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_timezonelocalizedname_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonelocalizedname_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonelocalizedname_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_timezonelocalizedname_modifiedonbehalfby", null, value);
		...
		public XrmEbc.TimeZoneDefinition lk_timezonelocalizedname_timezonedefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TimeZoneDefinition>("lk_timezonelocalizedname_timezonedefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonelocalizedname_timezonedefinitionid");
				this.SetRelatedEntity<XrmEbc.TimeZoneDefinition>("lk_timezonelocalizedname_timezonedefinitionid", null, value);
