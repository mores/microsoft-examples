...
namespace XrmEbc
{
	...
	public partial class ReportEntity : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_reportentity
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_reportentity", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_reportentity");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_reportentity", null, value);
		...
		public XrmEbc.SystemUser lk_reportentity_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportentity_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportentity_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_reportentity_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_reportentity_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportentity_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportentity_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_reportentity_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_reportentitybase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportentitybase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_reportentitybase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportentitybase_modifiedby", null);
			}
		}
		...
		public XrmEbc.Report report_reportentities
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Report>("report_reportentities", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("report_reportentities");
				this.SetRelatedEntity<XrmEbc.Report>("report_reportentities", null, value);
