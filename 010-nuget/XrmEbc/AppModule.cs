...
namespace XrmEbc
{
	...
	public partial class AppModule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.AppModuleComponent> appmodule_appmodulecomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.AppModuleComponent>("appmodule_appmodulecomponent", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appmodulecomponent");
				this.SetRelatedEntities<XrmEbc.AppModuleComponent>("appmodule_appmodulecomponent", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.Role> appmoduleroles_association
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.Role>("appmoduleroles_association", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmoduleroles_association");
				this.SetRelatedEntities<XrmEbc.Role>("appmoduleroles_association", null, value);
		...
		public XrmEbc.SystemUser lk_appmodule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_appmodule_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_appmodule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_appmodule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appmodule_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_appmodule_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_appmodule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_appmodule_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_appmodule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_appmodule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appmodule_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_appmodule_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_appmodule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_appmodule", null);
			}
		}
		...
		public XrmEbc.Publisher publisher_appmodule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Publisher>("publisher_appmodule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("publisher_appmodule");
				this.SetRelatedEntity<XrmEbc.Publisher>("publisher_appmodule", null, value);
