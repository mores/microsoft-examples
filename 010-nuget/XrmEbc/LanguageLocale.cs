...
namespace XrmEbc
{
	...
	public partial class LanguageLocale : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.LanguageLocaleState> statecode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.LanguageLocaleState)(System.Enum.ToObject(typeof(XrmEbc.LanguageLocaleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.KnowledgeArticle> knowledgearticle_languagelocaleid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.KnowledgeArticle>("knowledgearticle_languagelocaleid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_languagelocaleid");
				this.SetRelatedEntities<XrmEbc.KnowledgeArticle>("knowledgearticle_languagelocaleid", null, value);
		...
		public XrmEbc.Organization languagelocale_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("languagelocale_organization", null);
			}
		}
