...
namespace XrmEbc
{
	...
	public partial class ListMember : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_listmember
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_listmember", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_listmember");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_listmember", null, value);
		...
		public XrmEbc.SystemUser lk_listmember_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_listmember_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_listmember_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_listmember_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_listmember_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_listmember_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_listmember_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_listmember_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_listmember_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_listmember_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_listmember_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_listmember_modifiedonbehalfby", null, value);
