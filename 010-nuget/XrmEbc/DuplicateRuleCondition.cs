...
namespace XrmEbc
{
	...
	public partial class DuplicateRuleCondition : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object OperatorCode
		{
			...
			get
			{
				return this.GetAttributeValue<object>("operatorcode");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SyncError> DuplicateRuleCondition_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SyncError>("DuplicateRuleCondition_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("DuplicateRuleCondition_SyncErrors");
				this.SetRelatedEntities<XrmEbc.SyncError>("DuplicateRuleCondition_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_duplicaterulecondition
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_duplicaterulecondition", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_duplicaterulecondition");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_duplicaterulecondition", null, value);
		...
		public XrmEbc.DuplicateRule DuplicateRule_DuplicateRuleConditions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.DuplicateRule>("DuplicateRule_DuplicateRuleConditions", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("DuplicateRule_DuplicateRuleConditions");
				this.SetRelatedEntity<XrmEbc.DuplicateRule>("DuplicateRule_DuplicateRuleConditions", null, value);
		...
		public XrmEbc.SystemUser lk_duplicaterulecondition_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_duplicaterulecondition_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_duplicaterulecondition_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_duplicaterulecondition_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_duplicaterulecondition_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_duplicaterulecondition_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_duplicaterulecondition_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_duplicaterulecondition_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_duplicateruleconditionbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_duplicateruleconditionbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_duplicateruleconditionbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_duplicateruleconditionbase_modifiedby", null);
			}
		}
