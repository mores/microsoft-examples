...
namespace XrmEbc
{
	...
	public partial class PostLike : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.SystemUser lk_postlike_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_postlike_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_postlike_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_postlike_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_postlike_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_postlike_createdonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_postlike
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_postlike", null);
			}
		}
		...
		public XrmEbc.Post Post_Likes
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Post>("Post_Likes", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Post_Likes");
				this.SetRelatedEntity<XrmEbc.Post>("Post_Likes", null, value);
