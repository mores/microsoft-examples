...
namespace XrmEbc
{
	...
	public partial class ActionCardUserState : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.ActionCard ActionCardUserState_ActionCard
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.ActionCard>("ActionCardUserState_ActionCard", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActionCardUserState_ActionCard");
				this.SetRelatedEntity<XrmEbc.ActionCard>("ActionCardUserState_ActionCard", null, value);
		...
		public XrmEbc.TransactionCurrency TransactionCurrency_ActionCardUserState
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_ActionCardUserState", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_ActionCardUserState");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_ActionCardUserState", null, value);
