...
namespace XrmEbc
{
	...
	public partial class SdkMessageResponse : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SdkMessageResponseField> messageresponse_sdkmessageresponsefield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SdkMessageResponseField>("messageresponse_sdkmessageresponsefield", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("messageresponse_sdkmessageresponsefield");
				this.SetRelatedEntities<XrmEbc.SdkMessageResponseField>("messageresponse_sdkmessageresponsefield", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_sdkmessageresponse
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_sdkmessageresponse", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_sdkmessageresponse");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_sdkmessageresponse", null, value);
		...
		public XrmEbc.SystemUser createdby_sdkmessageresponse
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("createdby_sdkmessageresponse", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_sdkmessageresponse_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageresponse_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessageresponse_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageresponse_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_sdkmessageresponse_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageresponse_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessageresponse_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessageresponse_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SdkMessageRequest messagerequest_sdkmessageresponse
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SdkMessageRequest>("messagerequest_sdkmessageresponse", null);
			}
		}
		...
		public XrmEbc.SystemUser modifiedby_sdkmessageresponse
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("modifiedby_sdkmessageresponse", null);
			}
		}
		...
		public XrmEbc.Organization organization_sdkmessageresponse
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_sdkmessageresponse", null);
			}
		}
