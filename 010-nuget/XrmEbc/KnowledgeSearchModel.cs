...
namespace XrmEbc
{
	...
	public partial class KnowledgeSearchModel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.KnowledgeSearchModelState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.KnowledgeSearchModelState)(System.Enum.ToObject(typeof(XrmEbc.KnowledgeSearchModelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TextAnalyticsEntityMapping> knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TextAnalyticsEntityMapping>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntities<XrmEbc.TextAnalyticsEntityMapping>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public XrmEbc.AzureServiceConnection azureserviceconnection_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.AzureServiceConnection>("azureserviceconnection_knowledgesearchmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_knowledgesearchmodel");
				this.SetRelatedEntity<XrmEbc.AzureServiceConnection>("azureserviceconnection_knowledgesearchmodel", null, value);
		...
		public XrmEbc.SystemUser lk_knowledgesearchmodel_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgesearchmodel_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_knowledgesearchmodel_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_knowledgesearchmodel_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgesearchmodel_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_knowledgesearchmodel_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_knowledgesearchmodel", null);
			}
		}
