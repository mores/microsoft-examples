...
namespace XrmEbc
{
	...
	public partial class RecommendedDocument : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.SystemUser lk_recommendeddocument_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_recommendeddocument_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_recommendeddocument_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_recommendeddocument_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recommendeddocument_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_recommendeddocument_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_recommendeddocument_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_recommendeddocument_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_recommendeddocument_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_recommendeddocument_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recommendeddocument_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_recommendeddocument_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_recommendeddocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_recommendeddocument", null);
			}
		}
		...
		public XrmEbc.TransactionCurrency TransactionCurrency_recommendeddocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_recommendeddocument", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_recommendeddocument");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_recommendeddocument", null, value);
