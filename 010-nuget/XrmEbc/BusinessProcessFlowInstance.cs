...
namespace XrmEbc
{
	...
	public partial class BusinessProcessFlowInstance : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.BusinessProcessFlowInstanceState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.BusinessProcessFlowInstanceState)(System.Enum.ToObject(typeof(XrmEbc.BusinessProcessFlowInstanceState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public XrmEbc.SystemUser lk_businessprocessflowinstancebase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_businessprocessflowinstancebase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_businessprocessflowinstancebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_businessprocessflowinstancebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_businessprocessflowinstancebase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_businessprocessflowinstancebase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_businessprocessflowinstancebase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_businessprocessflowinstancebase_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_businessprocessflowinstancebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_businessprocessflowinstancebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_businessprocessflowinstancebase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_businessprocessflowinstancebase_modifiedonbehalfby", null, value);
