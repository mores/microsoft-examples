...
namespace XrmEbc
{
	...
	public partial class TeamTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SyncError> TeamTemplate_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SyncError>("TeamTemplate_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TeamTemplate_SyncErrors");
				this.SetRelatedEntities<XrmEbc.SyncError>("TeamTemplate_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.Team> teamtemplate_Teams
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.Team>("teamtemplate_Teams", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("teamtemplate_Teams");
				this.SetRelatedEntities<XrmEbc.Team>("teamtemplate_Teams", null, value);
		...
		public XrmEbc.SystemUser lk_teamtemplate_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_teamtemplate_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_teamtemplate_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_teamtemplate_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_teamtemplate_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_teamtemplate_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_teamtemplate_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_teamtemplate_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_teamtemplate_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_teamtemplate_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_teamtemplate_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_teamtemplate_modifiedonbehalfby", null, value);
