...
namespace XrmEbc
{
	...
	public partial class MailboxStatistics : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object OperationTypeId
		{
			...
			get
			{
				return this.GetAttributeValue<object>("operationtypeid");
			}
		}
		...
		public XrmEbc.Mailbox mailbox_mailboxstatistics
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Mailbox>("mailbox_mailboxstatistics", null);
			}
		}
		...
		public XrmEbc.Organization organization_mailboxstatistics
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_mailboxstatistics", null);
			}
		}
