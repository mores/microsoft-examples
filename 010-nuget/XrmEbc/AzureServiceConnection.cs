...
namespace XrmEbc
{
	...
	public partial class AzureServiceConnection : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object ConnectionType
		{
			...
			get
			{
				return this.GetAttributeValue<object>("connectiontype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public object LastConnectionStatusCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("lastconnectionstatuscode");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Nullable<XrmEbc.AzureServiceConnectionState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.AzureServiceConnectionState)(System.Enum.ToObject(typeof(XrmEbc.AzureServiceConnectionState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.AdvancedSimilarityRule> azureserviceconnection_advancedsimilarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.AdvancedSimilarityRule>("azureserviceconnection_advancedsimilarityrule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_advancedsimilarityrule");
				this.SetRelatedEntities<XrmEbc.AdvancedSimilarityRule>("azureserviceconnection_advancedsimilarityrule", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.KnowledgeSearchModel> azureserviceconnection_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.KnowledgeSearchModel>("azureserviceconnection_knowledgesearchmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_knowledgesearchmodel");
				this.SetRelatedEntities<XrmEbc.KnowledgeSearchModel>("azureserviceconnection_knowledgesearchmodel", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.RecommendationModel> azureserviceconnection_recommendationmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.RecommendationModel>("azureserviceconnection_recommendationmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_recommendationmodel");
				this.SetRelatedEntities<XrmEbc.RecommendationModel>("azureserviceconnection_recommendationmodel", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TopicModel> azureserviceconnection_topicmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TopicModel>("azureserviceconnection_topicmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_topicmodel");
				this.SetRelatedEntities<XrmEbc.TopicModel>("azureserviceconnection_topicmodel", null, value);
		...
		public XrmEbc.SystemUser lk_azureserviceconnection_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_azureserviceconnection_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_azureserviceconnection_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_azureserviceconnection_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_azureserviceconnection_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_azureserviceconnection_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_azureserviceconnection_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_azureserviceconnection_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_azureserviceconnection_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_azureserviceconnection_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_azureserviceconnection_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_azureserviceconnection_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_azureserviceconnection
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_azureserviceconnection", null);
			}
		}
