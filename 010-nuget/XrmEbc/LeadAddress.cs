...
namespace XrmEbc
{
	...
	public partial class LeadAddress : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SyncError> LeadAddress_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SyncError>("LeadAddress_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("LeadAddress_SyncErrors");
				this.SetRelatedEntities<XrmEbc.SyncError>("LeadAddress_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_leadaddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_leadaddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_leadaddress");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_leadaddress", null, value);
		...
		public XrmEbc.Lead lead_addresses
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Lead>("lead_addresses", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lead_addresses");
				this.SetRelatedEntity<XrmEbc.Lead>("lead_addresses", null, value);
		...
		public XrmEbc.SystemUser lk_leadaddress_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_leadaddress_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_leadaddress_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_leadaddress_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_leadaddress_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_leadaddress_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_leadaddress_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_leadaddress_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_leadaddressbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_leadaddressbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_leadaddressbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_leadaddressbase_modifiedby", null);
			}
		}
		...
		public XrmEbc.TransactionCurrency TransactionCurrency_LeadAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_LeadAddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_LeadAddress");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_LeadAddress", null, value);
