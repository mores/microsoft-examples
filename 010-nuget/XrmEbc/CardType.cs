...
namespace XrmEbc
{
	...
	public partial class CardType : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object ClientAvailability
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("clientavailability");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.ActionCard> cardtype_actioncard
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.ActionCard>("cardtype_actioncard", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("cardtype_actioncard");
				this.SetRelatedEntities<XrmEbc.ActionCard>("cardtype_actioncard", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.ActionCardUserSettings> cardtype_actioncardusersettings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.ActionCardUserSettings>("cardtype_actioncardusersettings", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("cardtype_actioncardusersettings");
				this.SetRelatedEntities<XrmEbc.ActionCardUserSettings>("cardtype_actioncardusersettings", null, value);
		...
		public XrmEbc.SystemUser lk_cardtype_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_cardtype_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_cardtype_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_cardtype_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_cardtype_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_cardtype_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_cardtype_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_cardtype_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_cardtype_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_cardtype_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_cardtype_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_cardtype_modifiedonbehalfby", null, value);
		...
		public XrmEbc.TransactionCurrency transactioncurrency_cardtype
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("transactioncurrency_cardtype", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("transactioncurrency_cardtype");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("transactioncurrency_cardtype", null, value);
