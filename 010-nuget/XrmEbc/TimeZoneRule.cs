...
namespace XrmEbc
{
	...
	public partial class TimeZoneRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_timezonerule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_timezonerule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_timezonerule");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_timezonerule", null, value);
		...
		public XrmEbc.SystemUser lk_timezonerule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonerule_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_timezonerule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonerule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonerule_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_timezonerule_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_timezonerule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonerule_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_timezonerule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_timezonerule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonerule_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_timezonerule_modifiedonbehalfby", null, value);
		...
		public XrmEbc.TimeZoneDefinition lk_timezonerule_timezonedefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TimeZoneDefinition>("lk_timezonerule_timezonedefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonerule_timezonedefinitionid");
				this.SetRelatedEntity<XrmEbc.TimeZoneDefinition>("lk_timezonerule_timezonedefinitionid", null, value);
