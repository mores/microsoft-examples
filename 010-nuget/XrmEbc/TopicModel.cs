...
namespace XrmEbc
{
	...
	public partial class TopicModel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.TopicModelState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.TopicModelState)(System.Enum.ToObject(typeof(XrmEbc.TopicModelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TopicModelConfiguration> topicmodel_topicmodelconfiguration
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TopicModelConfiguration>("topicmodel_topicmodelconfiguration", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodel_topicmodelconfiguration");
				this.SetRelatedEntities<XrmEbc.TopicModelConfiguration>("topicmodel_topicmodelconfiguration", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.TopicModelExecutionHistory> topicmodel_topicmodelexecutionhistory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.TopicModelExecutionHistory>("topicmodel_topicmodelexecutionhistory", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodel_topicmodelexecutionhistory");
				this.SetRelatedEntities<XrmEbc.TopicModelExecutionHistory>("topicmodel_topicmodelexecutionhistory", null, value);
		...
		public XrmEbc.AzureServiceConnection azureserviceconnection_topicmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.AzureServiceConnection>("azureserviceconnection_topicmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_topicmodel");
				this.SetRelatedEntity<XrmEbc.AzureServiceConnection>("azureserviceconnection_topicmodel", null, value);
		...
		public XrmEbc.SystemUser lk_topicmodel_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_topicmodel_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_topicmodel_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_topicmodel_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_topicmodel_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_topicmodel_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_topicmodel_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_topicmodel_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_topicmodel_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_topicmodel_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_topicmodel_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_topicmodel_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_topicmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_topicmodel", null);
			}
		}
		...
		public XrmEbc.TopicModelConfiguration topicmodelconfiguration_topicmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TopicModelConfiguration>("topicmodelconfiguration_topicmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_topicmodel");
				this.SetRelatedEntity<XrmEbc.TopicModelConfiguration>("topicmodelconfiguration_topicmodel", null, value);
