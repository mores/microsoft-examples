...
namespace XrmEbc
{
	...
	public partial class SdkMessageRequestField : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_sdkmessagerequestfield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_sdkmessagerequestfield", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_sdkmessagerequestfield");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_sdkmessagerequestfield", null, value);
		...
		public XrmEbc.SystemUser createdby_sdkmessagerequestfield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("createdby_sdkmessagerequestfield", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_sdkmessagerequestfield_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessagerequestfield_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessagerequestfield_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessagerequestfield_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_sdkmessagerequestfield_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessagerequestfield_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessagerequestfield_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_sdkmessagerequestfield_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SdkMessageRequest messagerequest_sdkmessagerequestfield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SdkMessageRequest>("messagerequest_sdkmessagerequestfield", null);
			}
		}
		...
		public XrmEbc.SystemUser modifiedby_sdkmessagerequestfield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("modifiedby_sdkmessagerequestfield", null);
			}
		}
		...
		public XrmEbc.Organization organization_sdkmessagerequestfield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_sdkmessagerequestfield", null);
			}
		}
