...
namespace XrmEbc
{
	...
	public partial class CustomControlResource : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.CustomControl customcontrol_resource_id
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.CustomControl>("customcontrol_resource_id", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("customcontrol_resource_id");
				this.SetRelatedEntity<XrmEbc.CustomControl>("customcontrol_resource_id", null, value);
		...
		public XrmEbc.Organization customcontrolresource_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("customcontrolresource_organization", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_customcontrolresource_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontrolresource_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_customcontrolresource_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontrolresource_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontrolresource_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_customcontrolresource_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_customcontrolresource_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontrolresource_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_customcontrolresource_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontrolresource_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontrolresource_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_customcontrolresource_modifiedonbehalfby", null, value);
