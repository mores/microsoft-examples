...
namespace XrmEbc
{
	...
	public partial class ProcessTrigger : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object ControlType
		{
			...
			get
			{
				return this.GetAttributeValue<object>("controltype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public object PipelineStage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("pipelinestage");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.SyncError> ProcessTrigger_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.SyncError>("ProcessTrigger_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ProcessTrigger_SyncErrors");
				this.SetRelatedEntities<XrmEbc.SyncError>("ProcessTrigger_SyncErrors", null, value);
		...
		public XrmEbc.SystemUser lk_processtriggerbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_processtriggerbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_processtriggerbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_processtriggerbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_processtriggerbase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_processtriggerbase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_processtriggerbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_processtriggerbase_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_processtriggerbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_processtriggerbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_processtriggerbase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_processtriggerbase_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Workflow process_processtrigger
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Workflow>("process_processtrigger", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("process_processtrigger");
				this.SetRelatedEntity<XrmEbc.Workflow>("process_processtrigger", null, value);
		...
		public XrmEbc.SystemForm processtrigger_systemform
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemForm>("processtrigger_systemform", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("processtrigger_systemform");
				this.SetRelatedEntity<XrmEbc.SystemForm>("processtrigger_systemform", null, value);
