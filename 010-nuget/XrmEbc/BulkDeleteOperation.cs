...
namespace XrmEbc
{
	...
	public partial class BulkDeleteOperation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<XrmEbc.BulkDeleteOperationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.BulkDeleteOperationState)(System.Enum.ToObject(typeof(XrmEbc.BulkDeleteOperationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.BulkDeleteFailure> BulkDeleteOperation_BulkDeleteFailure
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("BulkDeleteOperation_BulkDeleteFailure");
				this.SetRelatedEntities<XrmEbc.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_bulkdeleteoperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_bulkdeleteoperation");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null, value);
		...
		public XrmEbc.AsyncOperation AsyncOperation_BulkDeleteOperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.AsyncOperation>("AsyncOperation_BulkDeleteOperation", null);
			}
		}
		...
		public XrmEbc.BusinessUnit BulkDeleteOperation_BusinessUnit
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.BusinessUnit>("BulkDeleteOperation_BusinessUnit", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_bulkdeleteoperation_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_bulkdeleteoperation_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_bulkdeleteoperationbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_bulkdeleteoperationbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_bulkdeleteoperationbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_bulkdeleteoperationbase_modifiedby", null);
			}
		}
