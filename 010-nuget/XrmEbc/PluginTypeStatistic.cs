...
namespace XrmEbc
{
	...
	public partial class PluginTypeStatistic : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_plugintypestatistic
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_plugintypestatistic", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_plugintypestatistic");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_plugintypestatistic", null, value);
		...
		public XrmEbc.SystemUser createdby_plugintypestatistic
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("createdby_plugintypestatistic", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_plugintypestatisticbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_plugintypestatisticbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_plugintypestatisticbase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_plugintypestatisticbase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_plugintypestatisticbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_plugintypestatisticbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_plugintypestatisticbase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_plugintypestatisticbase_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser modifiedby_plugintypestatistic
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("modifiedby_plugintypestatistic", null);
			}
		}
		...
		public XrmEbc.Organization organization_plugintypestatistic
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_plugintypestatistic", null);
			}
		}
		...
		public XrmEbc.PluginType plugintype_plugintypestatistic
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.PluginType>("plugintype_plugintypestatistic", null);
			}
		}
