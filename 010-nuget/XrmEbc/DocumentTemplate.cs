...
namespace XrmEbc
{
	...
	public partial class DocumentTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.SystemUser lk_documenttemplatebase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_documenttemplatebase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_documenttemplatebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_documenttemplatebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_documenttemplatebase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_documenttemplatebase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_documenttemplatebase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_documenttemplatebase_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_documenttemplatebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_documenttemplatebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_documenttemplatebase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_documenttemplatebase_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization lk_documenttemplatebase_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("lk_documenttemplatebase_organization", null);
			}
		}
