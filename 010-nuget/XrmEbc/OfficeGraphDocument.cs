...
namespace XrmEbc
{
	...
	public partial class OfficeGraphDocument : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.SystemUser lk_officegraphdocument_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_officegraphdocument_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_officegraphdocument_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_officegraphdocument_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_officegraphdocument_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_officegraphdocument_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_officegraphdocument_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_officegraphdocument_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_officegraphdocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_officegraphdocument", null);
			}
		}
		...
		public XrmEbc.TransactionCurrency TransactionCurrency_officegraphdocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_officegraphdocument", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_officegraphdocument");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_officegraphdocument", null, value);
