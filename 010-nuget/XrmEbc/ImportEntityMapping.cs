...
namespace XrmEbc
{
	...
	public partial class ImportEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object DeDupe
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("dedupe");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Nullable<XrmEbc.ImportEntityMappingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.ImportEntityMappingState)(System.Enum.ToObject(typeof(XrmEbc.ImportEntityMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_importentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_importentitymapping");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null, value);
		...
		public XrmEbc.ImportMap ImportEntityMapping_ImportMap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.ImportMap>("ImportEntityMapping_ImportMap", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ImportEntityMapping_ImportMap");
				this.SetRelatedEntity<XrmEbc.ImportMap>("ImportEntityMapping_ImportMap", null, value);
		...
		public XrmEbc.SystemUser lk_importentitymapping_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_importentitymapping_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_importentitymapping_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_importentitymapping_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_importentitymapping_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_importentitymapping_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_importentitymapping_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_importentitymapping_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_importentitymapping_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_importentitymapping_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null, value);
