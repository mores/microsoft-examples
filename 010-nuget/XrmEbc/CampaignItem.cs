...
namespace XrmEbc
{
	...
	public partial class CampaignItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_campaignitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_campaignitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_campaignitem");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_campaignitem", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.Campaign> campaigncampaign_association
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.Campaign>("campaigncampaign_association", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("campaigncampaign_association");
				this.SetRelatedEntities<XrmEbc.Campaign>("campaigncampaign_association", null, value);
