...
namespace XrmEbc
{
	...
	public partial class ReportLink : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object LinkTypeCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("linktypecode");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_reportlink
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_reportlink", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_reportlink");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_reportlink", null, value);
		...
		public XrmEbc.SystemUser lk_reportlink_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportlink_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportlink_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_reportlink_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_reportlink_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportlink_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportlink_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_reportlink_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_reportlinkbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportlinkbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_reportlinkbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_reportlinkbase_modifiedby", null);
			}
		}
		...
		public XrmEbc.Report report_reportlink
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Report>("report_reportlink", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("report_reportlink");
				this.SetRelatedEntity<XrmEbc.Report>("report_reportlink", null, value);
		...
		public XrmEbc.Report report_reportlink_sub
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Report>("report_reportlink_sub", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("report_reportlink_sub");
				this.SetRelatedEntity<XrmEbc.Report>("report_reportlink_sub", null, value);
