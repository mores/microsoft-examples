...
namespace XrmEbc
{
	...
	public partial class CustomControlDefaultConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public XrmEbc.Organization customcontroldefaultconfig_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("customcontroldefaultconfig_organization", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_customcontroldefaultconfig_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontroldefaultconfig_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_customcontroldefaultconfig_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontroldefaultconfig_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontroldefaultconfig_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_customcontroldefaultconfig_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_customcontroldefaultconfig_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontroldefaultconfig_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_customcontroldefaultconfig_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_customcontroldefaultconfig_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontroldefaultconfig_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_customcontroldefaultconfig_modifiedonbehalfby", null, value);
