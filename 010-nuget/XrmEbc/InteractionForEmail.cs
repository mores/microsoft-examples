...
namespace XrmEbc
{
	...
	public partial class InteractionForEmail : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object InteractionType
		{
			...
			get
			{
				return this.GetAttributeValue<object>("interactiontype");
			}
		}
		...
		public System.Nullable<XrmEbc.InteractionForEmailState> statecode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((XrmEbc.InteractionForEmailState)(System.Enum.ToObject(typeof(XrmEbc.InteractionForEmailState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.ActivityPointer> interactionforemail_ActivityPointers
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.ActivityPointer>("interactionforemail_ActivityPointers", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_ActivityPointers");
				this.SetRelatedEntities<XrmEbc.ActivityPointer>("interactionforemail_ActivityPointers", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.adx_alertsubscription> interactionforemail_adx_alertsubscriptions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.adx_alertsubscription>("interactionforemail_adx_alertsubscriptions", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_adx_alertsubscriptions");
				this.SetRelatedEntities<XrmEbc.adx_alertsubscription>("interactionforemail_adx_alertsubscriptions", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.adx_inviteredemption> interactionforemail_adx_inviteredemptions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.adx_inviteredemption>("interactionforemail_adx_inviteredemptions", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_adx_inviteredemptions");
				this.SetRelatedEntities<XrmEbc.adx_inviteredemption>("interactionforemail_adx_inviteredemptions", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.adx_portalcomment> interactionforemail_adx_portalcomments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.adx_portalcomment>("interactionforemail_adx_portalcomments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_adx_portalcomments");
				this.SetRelatedEntities<XrmEbc.adx_portalcomment>("interactionforemail_adx_portalcomments", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.AsyncOperation> interactionforemail_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.AsyncOperation>("interactionforemail_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_AsyncOperations");
				this.SetRelatedEntities<XrmEbc.AsyncOperation>("interactionforemail_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.msdyn_approval> interactionforemail_msdyn_approvals
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.msdyn_approval>("interactionforemail_msdyn_approvals", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_msdyn_approvals");
				this.SetRelatedEntities<XrmEbc.msdyn_approval>("interactionforemail_msdyn_approvals", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.msdyn_bookingalert> interactionforemail_msdyn_bookingalerts
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.msdyn_bookingalert>("interactionforemail_msdyn_bookingalerts", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_msdyn_bookingalerts");
				this.SetRelatedEntities<XrmEbc.msdyn_bookingalert>("interactionforemail_msdyn_bookingalerts", null, value);
				this.OnPropertyChanged("interactionforemail_msdyn_bookingalerts");
			}
		}
		
		/// <summary>
		/// 1:N interactionforemail_msdyn_surveyinvites
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("interactionforemail_msdyn_surveyinvites")]
		public System.Collections.Generic.IEnumerable<XrmEbc.msdyn_surveyinvite> interactionforemail_msdyn_surveyinvites
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.msdyn_surveyinvite>("interactionforemail_msdyn_surveyinvites", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("interactionforemail_msdyn_surveyinvites");
				this.SetRelatedEntities<XrmEbc.msdyn_surveyinvite>("interactionforemail_msdyn_surveyinvites", null, value);
		...
		public XrmEbc.BusinessUnit business_unit_interactionforemail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.BusinessUnit>("business_unit_interactionforemail", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_interactionforemail_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_interactionforemail_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_interactionforemail_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_interactionforemail_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_interactionforemail_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_interactionforemail_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_interactionforemail_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_interactionforemail_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_interactionforemail_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_interactionforemail_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_interactionforemail_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_interactionforemail_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Team team_interactionforemail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Team>("team_interactionforemail", null);
			}
		}
		...
		public XrmEbc.TransactionCurrency TransactionCurrency_InteractionForEmail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_InteractionForEmail", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_InteractionForEmail");
				this.SetRelatedEntity<XrmEbc.TransactionCurrency>("TransactionCurrency_InteractionForEmail", null, value);
		...
		public XrmEbc.SystemUser user_interactionforemail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("user_interactionforemail", null);
			}
		}
