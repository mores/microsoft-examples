...
namespace XrmEbc
{
	...
	public partial class DisplayString : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.AsyncOperation> DisplayString_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.AsyncOperation>("DisplayString_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("DisplayString_AsyncOperations");
				this.SetRelatedEntities<XrmEbc.AsyncOperation>("DisplayString_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.BulkDeleteFailure> DisplayString_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.BulkDeleteFailure>("DisplayString_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("DisplayString_BulkDeleteFailures");
				this.SetRelatedEntities<XrmEbc.BulkDeleteFailure>("DisplayString_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_displaystring
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_displaystring", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_displaystring");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_displaystring", null, value);
		...
		public XrmEbc.SystemUser lk_DisplayStringbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_DisplayStringbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_DisplayStringbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_DisplayStringbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_DisplayStringbase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_DisplayStringbase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_DisplayStringbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_DisplayStringbase_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_DisplayStringbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_DisplayStringbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_DisplayStringbase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_DisplayStringbase_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Organization organization_custom_displaystrings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Organization>("organization_custom_displaystrings", null);
			}
		}
