...
namespace XrmEbc
{
	...
	public partial class RelationshipRoleMap : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.AsyncOperation> RelationshipRoleMap_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.AsyncOperation>("RelationshipRoleMap_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("RelationshipRoleMap_AsyncOperations");
				this.SetRelatedEntities<XrmEbc.AsyncOperation>("RelationshipRoleMap_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.BulkDeleteFailure> RelationshipRoleMap_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.BulkDeleteFailure>("RelationshipRoleMap_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("RelationshipRoleMap_BulkDeleteFailures");
				this.SetRelatedEntities<XrmEbc.BulkDeleteFailure>("RelationshipRoleMap_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_relationshiprolemap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_relationshiprolemap", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_relationshiprolemap");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_relationshiprolemap", null, value);
		...
		public XrmEbc.SystemUser createdby_relationship_role_map
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("createdby_relationship_role_map", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_relationshiprolemap_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_relationshiprolemap_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_relationshiprolemap_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_relationshiprolemap_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_relationshiprolemap_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_relationshiprolemap_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_relationshiprolemap_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_relationshiprolemap_modifiedonbehalfby", null, value);
		...
		public XrmEbc.SystemUser modifiedby_relationship_role_map
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("modifiedby_relationship_role_map", null);
			}
		}
		...
		public XrmEbc.RelationshipRole relationship_role_relationship_role_map
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.RelationshipRole>("relationship_role_relationship_role_map", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("relationship_role_relationship_role_map");
				this.SetRelatedEntity<XrmEbc.RelationshipRole>("relationship_role_relationship_role_map", null, value);
