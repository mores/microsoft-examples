...
namespace XrmEbc
{
	...
	public partial class CampaignActivityItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_campaignactivityitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_campaignactivityitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_campaignactivityitem");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_campaignactivityitem", null, value);
		...
		public XrmEbc.ActivityPointer ActivityPointer_CampaignActivityItems
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.ActivityPointer>("ActivityPointer_CampaignActivityItems", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActivityPointer_CampaignActivityItems");
				this.SetRelatedEntity<XrmEbc.ActivityPointer>("ActivityPointer_CampaignActivityItems", null, value);
