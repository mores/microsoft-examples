...
namespace XrmEbc
{
	...
	public partial class PublisherAddress : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_publisheraddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_publisheraddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_publisheraddress");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_publisheraddress", null, value);
		...
		public XrmEbc.SystemUser lk_publisheraddressbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_publisheraddressbase_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_publisheraddressbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_publisheraddressbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_publisheraddressbase_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_publisheraddressbase_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser lk_publisheraddressbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_publisheraddressbase_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser lk_publisheraddressbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("lk_publisheraddressbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_publisheraddressbase_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("lk_publisheraddressbase_modifiedonbehalfby", null, value);
		...
		public XrmEbc.Publisher Publisher_PublisherAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Publisher>("Publisher_PublisherAddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Publisher_PublisherAddress");
				this.SetRelatedEntity<XrmEbc.Publisher>("Publisher_PublisherAddress", null, value);
