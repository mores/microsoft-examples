...
namespace XrmEbc
{
	...
	public partial class WorkflowDependency : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<XrmEbc.UserEntityInstanceData> userentityinstancedata_workflowdependency
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_workflowdependency", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_workflowdependency");
				this.SetRelatedEntities<XrmEbc.UserEntityInstanceData>("userentityinstancedata_workflowdependency", null, value);
		...
		public XrmEbc.SdkMessage sdkmessageid_workflow_dependency
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SdkMessage>("sdkmessageid_workflow_dependency", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdkmessageid_workflow_dependency");
				this.SetRelatedEntity<XrmEbc.SdkMessage>("sdkmessageid_workflow_dependency", null, value);
		...
		public XrmEbc.Workflow workflow_dependencies
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.Workflow>("workflow_dependencies", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("workflow_dependencies");
				this.SetRelatedEntity<XrmEbc.Workflow>("workflow_dependencies", null, value);
		...
		public XrmEbc.SystemUser workflow_dependency_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("workflow_dependency_createdby", null);
			}
		}
		...
		public XrmEbc.SystemUser workflow_dependency_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("workflow_dependency_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("workflow_dependency_createdonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("workflow_dependency_createdonbehalfby", null, value);
		...
		public XrmEbc.SystemUser workflow_dependency_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("workflow_dependency_modifiedby", null);
			}
		}
		...
		public XrmEbc.SystemUser workflow_dependency_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<XrmEbc.SystemUser>("workflow_dependency_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("workflow_dependency_modifiedonbehalfby");
				this.SetRelatedEntity<XrmEbc.SystemUser>("workflow_dependency_modifiedonbehalfby", null, value);
